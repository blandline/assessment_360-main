...
var Raterlist = function() {
    ...
    $("body").on("click", ".raterlist-add-btn", function() {
        ...
        cell7.innerHTML = "<select name='rows[" + rowcounter +"][Roles]' id='roles' style='width: 95px;'><option value='' disabled selected>"+ lang["listofraters_role"] +"&#9660;</option><option value='Focus' name='focus_role'>"+ lang["listofraters_role_focus"] +"</option><option value='manager' name='manager_role'>"+ lang["listofraters_role_manager"] +"</option><option value='colleague' name='colleague_role'>"+lang["listofraters_role_colleague"]+"</option><option value='direct-report' name='direct_report_role'>"+lang["listofraters_role_directreport"]+"</option><option value='Other' name='other_role'>"+lang["listofraters_role_other"]+"</option></select>";
        cell8.innerHTML = "<select name='rows[" + rowcounter +"][Genders]' id='genders' style='width: 80px;'><option value='' disabled selected>"+ lang["listofraters_gender"] +"&#9660</option><option value='Male' name='male_gender'>"+ lang["listofraters_gender_male"] +"</option><option value='Female' name='female_gender'>"+ lang["listofraters_gender_female"] +"</option><option value='Other Gender' name='other_gender'>"+ lang["listofraters_gender_other"] +"</option></select>";
