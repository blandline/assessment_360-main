<div class="sidebar" data-color="danger" data-background-color="white">
  ...
  <div class="sidebar-wrapper" id="leftmenubar">
    <ul class="nav">
      ...
      <?/*
      $isShowListOfRaters = !empty(@$_SESSION[$session_admin]) || (in_array($PACKAGE_LIST_OF_RATERS, $_SESSION[$session_package]) && $login->checkUserPermission($PERMISSION_ASSESS360_VIEW));
      ...
      ?>
        ...
        <li class="nav-item <? if ($isViewListOfRaters) echo "leftMenuActive"; ?>">
          <a class="nav-link" href="./listofraters">
